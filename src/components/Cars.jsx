...
import { addCarsBasket, fetchCarsData } from "../redux/action/carsAction";
      ...
      <section className="container mx-auto flex items-center justify-between flex-wrap gap-10">
        {carsData.map((car) => (
          ...
          >
            ...
            <button onClick={()=>dispatch(addCarsBasket(car))} className="self-center text-3xl font-bold border-2 px-3 rounded-lg border-[#dadadad]">
              Add to Basket
            </button>
          </div>
        ))}
